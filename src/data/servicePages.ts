...
export const servicePages: Record<string, ServicePageData> = {
  branding: {
    ...
    metaDescription: "Build a brand that earns trust and drives revenue. We craft logos, visual identities, and brand systems grounded in strategy. Book a free brand consultation today.",
    metaKeywords: ["branding agency Chandigarh", "logo design Canada", "brand identity design", "brand strategy services", "corporate branding", "visual identity design", "brand guidelines"],
    seoContent: [
  ...
  "google-ads": {
    ...
    metaKeywords: ["Google Ads agency Chandigarh", "PPC management Canada", "SEM services", "Google Partner agency", "ROAS optimization", "pay per click advertising", "search engine marketing"],
    seoContent: [
    ...
    deepContent: [
      {
        ...
        paragraphs: [
          ...
          "For Canadian businesses specifically, understanding the Google Ads landscape means accounting for bilingual targeting, mobile-first user behaviour, and highly variable cost-per-click rates across industries. A real estate lead keyword in Toronto might cost $8–15 per click, while a local service keyword in Chandigarh might cost $3–8. We map these economics before launching any campaign to ensure your budget is allocated where it delivers the best returns.",
        ],
      },
      {
  ...
  seo: {
    ...
    description: "Proven SEO strategies that boost your rankings, drive organic traffic, and grow your business sustainably. Our SEO team in Chandigarh specializes in technical SEO, on-page optimization, local SEO, and link building to help businesses across Canada achieve first-page rankings on Google for competitive keywords.",
    ...
    metaDescription: "Grow your organic traffic with SEO strategies built on data, not guesswork. Technical audits, content, and link building that deliver rankings. Get a free SEO audit.",
    metaKeywords: ["SEO services Chandigarh", "organic search optimization", "local SEO Canada", "technical SEO audit", "Google rankings", "search engine optimization agency", "link building services"],
    seoContent: [
      ...
      "Local SEO is essential for businesses targeting customers in specific regions. Our team optimizes your Google Business Profile, builds consistent local citations, manages online reviews, and implements location-specific content strategies. Whether you serve Chandigarh, the greater Alberta region, or clients across Canada, our local SEO expertise helps you dominate map pack results and local search queries.",
    ],
    deepContent: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Local SEO determines which businesses appear when someone searches 'near me' or includes a city name in their query. For Chandigarh businesses, the competition in the local map pack is intensifying across sectors like restaurants, clinics, salons, tutoring centres, and professional services. The three pillars of local ranking are: relevance (how well your Google Business Profile matches the search query), distance (how close you are to the searcher), and prominence (how well-known and trusted your business is online).",
          "Your Google Business Profile (GBP) is the single most important local SEO asset. We optimise every field — primary and secondary categories, business description with natural keyword integration, service areas, attributes, products/services listings, and Q&A sections. We post weekly GBP updates with photos, offers, and event announcements, which signals to Google that your business is active. For multi-location businesses in Chandigarh and the greater Chandigarh area, we create and optimise individual profiles for each location with unique descriptions and location-specific content.",
  ...
  "website-development": {
    ...
    metaKeywords: ["website development Chandigarh", "web design Canada", "Next.js development", "React website", "WordPress developer", "e-commerce website", "responsive web design", "custom web application"],
    seoContent: [
  ...
  "social-media": {
    ...
    description: "Strategic social media management that grows your audience, builds brand loyalty, and generates leads. Our social media team in Chandigarh creates scroll-stopping content for Instagram, Facebook, LinkedIn, and other platforms, combining organic content marketing with paid social campaigns to deliver real business results across Canada.",
    ...
    metaKeywords: ["social media marketing Chandigarh", "Instagram marketing Canada", "Facebook advertising", "LinkedIn marketing", "content marketing agency", "social media management", "influencer marketing"],
    seoContent: [
  ...
  "lead-generation": {
    ...
    description: "Data-driven lead generation strategies that attract, capture, and convert high-quality prospects for your business. Our team in Chandigarh builds complete lead generation systems using landing pages, conversion optimization, CRM integration, and multi-channel campaigns to deliver qualified leads that fuel sustainable growth for businesses across Canada.",
    ...
    metaKeywords: ["lead generation Chandigarh", "landing page optimization", "conversion rate optimization", "CRM integration services", "B2B lead generation Canada", "sales funnel optimization", "lead nurturing"],
    seoContent: [
  ...
  "music-release": {
    ...
    metaKeywords: ["music release services", "Spotify playlist pitching", "music distribution Canada", "Punjabi music promotion", "music marketing Chandigarh", "artist promotion", "music PR services"],
    seoContent: [
  ...
  "video-editing": {
    ...
    description: "Professional video editing and production services that bring your vision to life with cinematic quality. Our post-production team in Chandigarh delivers everything from social media reels and corporate videos to commercial productions, combining expert editing, motion graphics, and colour grading to create content that captivates audiences across Canada.",
    ...
    metaKeywords: ["video editing services Chandigarh", "post-production Canada", "social media reels editing", "corporate video production", "motion graphics", "colour grading", "video production agency"],
    seoContent: [
      ...
      "With over two thousand videos produced and a hundred million views generated, TML is a trusted video production partner for businesses and creators across Chandigarh and Canada. Our standard turnaround of forty-eight hours for short-form content means you never miss a trend or deadline. From Punjabi music videos to corporate explainers and e-commerce product videos, we bring creative excellence and technical precision to every project.",
    ],
    deepContent: [
  ...
  "branding-packaging": {
    ...
    metaKeywords: ["packaging design Chandigarh", "label design Canada", "product packaging services", "print design agency", "box design", "retail packaging", "packaging branding"],
    seoContent: [
  ...
  "graphic-design": {
    ...
    description: "Professional graphic design services that bring your brand story to life across every visual touchpoint. Our design team in Chandigarh creates stunning social media graphics, print materials, presentations, and ad creatives that combine aesthetic excellence with strategic communication to help brands across Canada engage their audiences effectively.",
    ...
    metaKeywords: ["graphic design services Chandigarh", "visual design Canada", "social media graphics", "print design agency", "presentation design", "ad creative design", "infographic design"],
    seoContent: [
  ...
  "link-building": {
    ...
    metaKeywords: ["link building services", "backlink building agency", "SEO link building Chandigarh", "white hat link building", "guest posting services", "digital PR Canada", "authority building"],
    seoContent: [
  ...
  "meta-ads": {
    ...
    metaKeywords: ["Meta ads agency", "Facebook ads Chandigarh", "Instagram advertising Canada", "social media advertising", "Facebook marketing agency", "Meta business partner", "paid social media"],
    seoContent: [
  ...
  "gmb-listing": {
    ...
    metaKeywords: ["GMB listing services", "Google My Business optimisation", "local SEO Chandigarh", "Google Business Profile management", "local search ranking", "GMB agency Canada", "local SEO services"],
    seoContent: [
  ...
  "content-marketing": {
    ...
    metaKeywords: ["content marketing services", "content marketing agency Chandigarh", "content strategy Canada", "blog marketing", "inbound marketing", "thought leadership content", "content distribution"],
    seoContent: [
  ...
  "email-marketing": {
    ...
    description: "Strategic email marketing services that nurture leads, retain customers, and drive revenue on autopilot. Our email marketing team in Chandigarh designs, builds, and optimises email campaigns and automation flows that deliver an average 42:1 ROI for businesses across Canada and internationally.",
    ...
    metaKeywords: ["email marketing services", "email marketing agency Chandigarh", "email automation Canada", "email campaign management", "drip email campaigns", "newsletter marketing", "email list building"],
    seoContent: [
  ...
  "influencer-marketing": {
    ...
    metaKeywords: ["influencer marketing agency", "influencer marketing Chandigarh", "Instagram influencer campaigns", "YouTube influencer marketing", "brand influencer collaboration Canada", "micro influencer marketing", "influencer management agency"],
    seoContent: [
  ...
  "ppc-management": {
    ...
    metaKeywords: ["PPC management agency", "pay per click management Chandigarh", "paid advertising Canada", "multi-platform PPC", "Google Ads management", "Meta ads management", "PPC agency Canada"],
    seoContent: [
  ...
  "online-reputation-management": {
    ...
    metaKeywords: ["online reputation management", "ORM services Canada", "brand reputation management", "reputation management agency Chandigarh", "negative content removal", "review management", "crisis PR"],
    seoContent: [
  ...
  "conversion-rate-optimization": {
    ...
    metaKeywords: ["conversion rate optimization", "CRO services Canada", "A/B testing agency", "CRO agency Chandigarh", "website conversion optimization", "landing page optimization", "user experience optimization"],
    seoContent: [
  ...
  "ecommerce-marketing": {
    ...
    metaKeywords: ["e-commerce marketing agency", "Shopify marketing Canada", "WooCommerce marketing", "e-commerce growth agency Chandigarh", "online store marketing", "e-commerce SEO", "e-commerce advertising"],
    seoContent: [
