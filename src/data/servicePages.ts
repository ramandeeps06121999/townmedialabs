...
export const servicePages: Record<string, ServicePageData> = {
  ...
  seo: {
    ...
    seoContent: [
      ...
      "Local SEO is essential for businesses targeting customers in specific regions. Our team optimizes your Google Business Profile, builds consistent local citations, manages online reviews, and implements location-specific content strategies. Whether you serve Chandigarh, the greater Punjab region, or clients across India and globally, our local SEO expertise helps you dominate map pack results and local search queries.",
    ],
    deepContent: [
      {
  ...
  "website-development": {
    ...
    deepContent: [
      ...
      },
      {
        ...
        paragraphs: [
          "Globally, mobile devices account for over 60% of all internet traffic, and Google has fully transitioned to mobile-first indexing — meaning it evaluates the mobile version of your site for all ranking decisions. If your website is not designed and developed with mobile as the primary experience, you are building for the minority of your audience. At TML, every project starts with mobile wireframes and prototypes before we even consider the desktop layout.",
  ...
  "social-media": {
    ...
    seoContent: [
      ...
      "We have managed social media for over a hundred brands across industries in Chandigarh and worldwide. Our campaigns consistently deliver above-average engagement rates because we focus on creating genuine connections between brands and their audiences. From startups building their first social presence to established brands looking for growth, TML delivers social media strategies that translate into real business outcomes.",
    ],
    deepContent: [
      {
  ...
  "branding-packaging": {
    ...
    deepContent: [
      ...
      { heading: "Sustainable Packaging: Meeting Consumer Demand While Staying on Brand", paragraphs: ["73% of consumers say they would change consumption habits to reduce environmental impact. Sustainable packaging is a competitive advantage. We design with eco-friendly materials, minimal waste principles, and recyclable structures without compromising visual impact.", "Our team works with kraft paper, sugarcane bagasse, recycled cardboard, and biodegradable films. We help brands communicate sustainability through earthy colour palettes, tactile textures, and clear recycling instructions that resonate with environmentally conscious consumers."] },
      { heading: "From Concept to Shelf: Our Packaging Design Process", paragraphs: ["Our process begins with market research — analysing competitors' shelf presence, identifying visual gaps, and understanding your target consumer. We develop 2-3 creative directions presented as photorealistic 3D mockups. After refinement, we prepare production files with exact colour specifications (Pantone/CMYK), dieline templates, and material callouts.", "We coordinate with your printing partner or recommend trusted printers from our network across India and internationally. Our team manages pre-press proofing, colour matching, and production sampling. From concept to shelf-ready packaging, typical timelines run 4-8 weeks."] },
    ],
  ...
  "content-marketing": {
    ...
    seoContent: [
      ...
      "Content marketing is a compounding investment — every piece of high-quality content you publish continues working for months and years after publication. Our clients consistently see 40-80% increases in organic traffic within 6 months of implementing a structured content marketing strategy, with ongoing gains as their content library grows and their domain authority strengthens.",
    ],
    deepContent: [
      {
  ...
  "influencer-marketing": {
    ...
    seoContent: [
      ...
      "The influencer landscape in India is among the most dynamic globally, with thousands of active influencers across Instagram, YouTube, and emerging platforms. The key to influencer marketing success is not finding the biggest creator — it is finding the right creator whose audience engagement, follower demographics, and content style align with your brand. Our proprietary influencer vetting process analyses real audience data, not follower counts, to identify creators who will actually move the needle for your business.",
    ...
    features: [
      ...
      { title: "Content Review & Approvals", description: "Structured content review workflow ensuring brand safety, advertising standards compliance, and quality standards without stifling the natural creator voice that makes influencer content effective." },
