...
const PHONE_NUMBER = "+14036048692";
    ...
    >
      <div className="bg-[#050505]/95 backdrop-blur-lg border-t border-white/10 px-4 py-3 flex gap-3" role="group" aria-label="Quick contact actions">
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl border border-white/10 text-white text-sm font-medium hover:bg-white/5 transition-colors"
        >
