...
const AboutHome2 = dynamic(() => import("@/components/sections/AboutHome2").then((mod) => ({ default: mod.AboutHome2 })));
const MeetTheTeam = dynamic(() => import("@/components/sections/MeetTheTeam").then((mod) => ({ default: mod.MeetTheTeam })), { ssr: false });
const ServicesHome2 = dynamic(() => import("@/components/sections/ServicesHome2").then((mod) => ({ default: mod.ServicesHome2 })));
...
const ProcessHome2 = dynamic(() => import("@/components/sections/ProcessHome2").then((mod) => ({ default: mod.ProcessHome2 })));
const CampaignPlans = dynamic(() => import("@/components/sections/CampaignPlans").then((mod) => ({ default: mod.CampaignPlans })), { ssr: false });
const TestimonialsHome2 = dynamic(() => import("@/components/sections/TestimonialsHome2").then((mod) => ({ default: mod.TestimonialsHome2 })));
const FAQHome2 = dynamic(() => import("@/components/sections/FAQHome2").then((mod) => ({ default: mod.FAQHome2 })));
