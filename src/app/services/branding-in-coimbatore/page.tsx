...
export const metadata: Metadata = {
  title: "Branding Agency in Coimbatore | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-coimbatore",
  },
  openGraph: {
    title: "Branding Agency in Coimbatore | TML Agency",
    description: "TML offers expert branding services in Coimbatore. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-coimbatore",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
