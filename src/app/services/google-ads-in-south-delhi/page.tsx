...
export const metadata: Metadata = {
  title: "Google Ads Agency in South Delhi | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-south-delhi",
  },
  openGraph: {
    title: "Google Ads Agency in South Delhi | TML Agency",
    description: "TML offers expert Google Ads management services in South Delhi. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-south-delhi",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
