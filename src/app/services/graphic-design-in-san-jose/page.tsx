...
export const metadata: Metadata = {
  title: "Graphic Design Agency in San Jose | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-san-jose",
  },
  openGraph: {
    title: "Graphic Design Agency in San Jose | TML Agency",
    description: "TML offers expert graphic design services in San Jose. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-san-jose",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
