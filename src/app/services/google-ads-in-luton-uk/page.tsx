...
export const metadata: Metadata = {
  title: "Google Ads Agency in Luton | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-luton-uk",
  },
  openGraph: {
    title: "Google Ads Agency in Luton | TML Agency",
    description: "TML offers expert google ads services in Luton. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-luton-uk",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
