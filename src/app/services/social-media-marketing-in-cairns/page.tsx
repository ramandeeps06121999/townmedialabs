...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Cairns | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-cairns",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Cairns | TML Agency",
    description: "TML offers expert social media marketing services in Cairns. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-cairns",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
