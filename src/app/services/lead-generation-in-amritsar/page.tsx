...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Amritsar | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-amritsar",
  },
  openGraph: {
    title: "Lead Generation Agency in Amritsar | TML Agency",
    description: "TML offers expert lead generation services in Amritsar. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-amritsar",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Lead Generation Agency in Amritsar | TML Agency" }],
  },
  twitter: {
