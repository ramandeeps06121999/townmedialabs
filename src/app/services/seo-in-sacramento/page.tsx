...
export const metadata: Metadata = {
  title: "SEO Agency in Sacramento | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/seo-in-sacramento",
  },
  openGraph: {
    title: "SEO Agency in Sacramento | TML Agency",
    description: "TML offers expert seo services in Sacramento. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/seo-in-sacramento",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
