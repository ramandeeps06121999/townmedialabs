...
export const metadata: Metadata = {
  title: "Packaging Design Agency in Manchester",
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/branding-packaging-in-manchester",
  },
  openGraph: {
    title: "Packaging Design Agency in Manchester",
    description: "TML offers expert Packaging Design services in Manchester. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.com/services/branding-packaging-in-manchester",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Packaging Design Agency in Manchester" }],
  },
  twitter: {
