...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Reading | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-reading",
  },
  openGraph: {
    title: "Lead Generation Agency in Reading | TML Agency",
    description: "TML offers expert lead generation services in Reading. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-reading",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
