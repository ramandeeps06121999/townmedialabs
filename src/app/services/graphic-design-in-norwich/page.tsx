...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Norwich | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-norwich",
  },
  openGraph: {
    title: "Graphic Design Agency in Norwich | TML Agency",
    description: "TML offers expert graphic design services in Norwich. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-norwich",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
