...
export const metadata: Metadata = {
  ...
  title: "AI Influencer Management Agency in Al Ain | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-al-ain",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Al Ain | TML Agency",
    description: "TML offers expert ai influencer management services in Al Ain. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-al-ain",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
