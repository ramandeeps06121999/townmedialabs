...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Ras Al Khaimah | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-ras-al-khaimah",
  },
  openGraph: {
    title: "Graphic Design Agency in Ras Al Khaimah | TML Agency",
    description: "TML offers expert graphic design services in Ras Al Khaimah. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-ras-al-khaimah",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
