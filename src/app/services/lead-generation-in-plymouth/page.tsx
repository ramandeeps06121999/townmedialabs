...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Plymouth | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-plymouth",
  },
  openGraph: {
    title: "Lead Generation Agency in Plymouth | TML Agency",
    description: "TML offers expert lead generation services in Plymouth. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-plymouth",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
