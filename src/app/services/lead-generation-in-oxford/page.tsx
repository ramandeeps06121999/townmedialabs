...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Oxford | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-oxford",
  },
  openGraph: {
    title: "Lead Generation Agency in Oxford | TML Agency",
    description: "TML offers expert lead generation services in Oxford. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-oxford",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
