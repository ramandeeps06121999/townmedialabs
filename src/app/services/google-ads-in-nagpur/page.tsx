...
export const metadata: Metadata = {
  title: "Google Ads Agency in Nagpur | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-nagpur",
  },
  openGraph: {
    title: "Google Ads Agency in Nagpur | TML Agency",
    description: "TML offers expert Google Ads management services in Nagpur. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-nagpur",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
