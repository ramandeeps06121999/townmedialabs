...
export const metadata: Metadata = {
  title: "Branding Agency in Bendigo | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-bendigo",
  },
  openGraph: {
    title: "Branding Agency in Bendigo | TML Agency",
    description: "TML offers expert branding services in Bendigo. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-bendigo",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Branding Agency in Bendigo | TML Agency" }],
  },
  twitter: {
