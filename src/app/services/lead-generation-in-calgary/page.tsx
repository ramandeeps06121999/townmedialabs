...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Calgary | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-calgary",
  },
  openGraph: {
    title: "Lead Generation Agency in Calgary | TML Agency",
    description: "TML offers expert lead generation services in Calgary, Alberta. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-calgary",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
