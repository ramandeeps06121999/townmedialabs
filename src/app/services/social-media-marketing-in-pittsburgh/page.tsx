...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Pittsburgh | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-pittsburgh",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Pittsburgh | TML Agency",
    description: "TML offers expert social media marketing services in Pittsburgh. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-pittsburgh",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
