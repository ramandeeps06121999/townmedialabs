...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Toowoomba | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-toowoomba",
  },
  openGraph: {
    title: "Lead Generation Agency in Toowoomba | TML Agency",
    description: "TML offers expert lead generation services in Toowoomba. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-toowoomba",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
