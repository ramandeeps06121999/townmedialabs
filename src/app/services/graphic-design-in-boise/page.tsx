...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Boise",
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/graphic-design-in-boise",
  },
  openGraph: {
    title: "Graphic Design Agency in Boise",
    description: "TML offers expert Graphic Design services in Boise. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.com/services/graphic-design-in-boise",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Graphic Design Agency in Boise" }],
  },
  twitter: {
