...
export const metadata: Metadata = {
  title: "Google Ads Agency in Al Ain | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-al-ain",
  },
  openGraph: {
    title: "Google Ads Agency in Al Ain | TML Agency",
    description: "TML offers expert google ads services in Al Ain. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-al-ain",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
