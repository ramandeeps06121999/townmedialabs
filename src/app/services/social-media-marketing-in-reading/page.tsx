...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Reading | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-reading",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Reading | TML Agency",
    description: "TML offers expert social media marketing services in Reading. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-reading",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
