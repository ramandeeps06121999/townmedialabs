...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Oklahoma City | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-oklahoma-city",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Oklahoma City | TML Agency",
    description: "TML offers expert social media marketing services in Oklahoma City. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-oklahoma-city",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
