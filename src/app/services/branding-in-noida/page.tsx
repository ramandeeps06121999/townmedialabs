...
export const metadata: Metadata = {
  title: "Branding Agency in Noida | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-noida",
  },
  openGraph: {
    title: "Branding Agency in Noida | TML Agency",
    description: "TML offers expert branding services in Noida. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-noida",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
