...
export const metadata: Metadata = {
  title: "Branding Agency in Punjab | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-punjab",
  },
  openGraph: {
    title: "Branding Agency in Punjab | TML Agency",
    description: "TML offers expert branding services in Punjab. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-punjab",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
