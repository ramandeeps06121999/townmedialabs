...
export const metadata: Metadata = {
  title: "Branding Agency in Sunshine Coast | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-sunshine-coast",
  },
  openGraph: {
    title: "Branding Agency in Sunshine Coast | TML Agency",
    description: "TML offers expert branding services in Sunshine Coast. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-sunshine-coast",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
