...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Louisville | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-louisville",
  },
  openGraph: {
    title: "Lead Generation Agency in Louisville | TML Agency",
    description: "TML offers expert lead generation services in Louisville. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-louisville",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
