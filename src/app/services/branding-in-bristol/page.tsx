...
export const metadata: Metadata = {
  title: "Branding Agency in Bristol | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-bristol",
  },
  openGraph: {
    title: "Branding Agency in Bristol | TML Agency",
    description: "TML offers expert branding services in Bristol. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-bristol",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
