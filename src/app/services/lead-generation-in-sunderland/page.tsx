...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Sunderland | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-sunderland",
  },
  openGraph: {
    title: "Lead Generation Agency in Sunderland | TML Agency",
    description: "TML offers expert lead generation services in Sunderland. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-sunderland",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
