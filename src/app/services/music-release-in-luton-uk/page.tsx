...
export const metadata: Metadata = {
  ...
  title: "Music Release Agency in Luton | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-luton-uk",
  },
  openGraph: {
    title: "Music Release Agency in Luton | TML Agency",
    description: "TML offers expert music release services in Luton. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-luton-uk",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
