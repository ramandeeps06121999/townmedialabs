...
export const metadata: Metadata = {
  title: "Video Editing Agency in Portland",
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/video-editing-in-portland",
  },
  openGraph: {
    title: "Video Editing Agency in Portland",
    description: "TML offers expert Video Editing services in Portland. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.com/services/video-editing-in-portland",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Video Editing Agency in Portland" }],
  },
  twitter: {
