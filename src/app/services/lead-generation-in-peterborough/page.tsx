...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Peterborough | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-peterborough",
  },
  openGraph: {
    title: "Lead Generation Agency in Peterborough | TML Agency",
    description: "TML offers expert lead generation services in Peterborough. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-peterborough",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
