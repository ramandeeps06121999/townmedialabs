...
export const metadata: Metadata = {
  ...
  title: "Music Release Agency in Palmerston North | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-palmerston-north",
  },
  openGraph: {
    title: "Music Release Agency in Palmerston North | TML Agency",
    description: "TML offers expert music release services in Palmerston North, New Zealand. Proven results for businesses across NZ. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-palmerston-north",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
