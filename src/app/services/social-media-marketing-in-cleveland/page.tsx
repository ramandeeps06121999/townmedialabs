...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Cleveland | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-cleveland",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Cleveland | TML Agency",
    description: "TML offers expert social media marketing services in Cleveland. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-cleveland",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
