...
export const metadata: Metadata = {
  title: "Branding Agency in Chennai | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-chennai",
  },
  openGraph: {
    title: "Branding Agency in Chennai | TML Agency",
    description: "TML offers expert branding services in Chennai. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-chennai",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
