...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Abu Dhabi | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-abu-dhabi",
  },
  openGraph: {
    title: "Lead Generation Agency in Abu Dhabi | TML Agency",
    description: "TML offers expert lead generation services in Abu Dhabi. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-abu-dhabi",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
