...
export const metadata: Metadata = {
  title: "AI Influencer Management Agency in Dunedin | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-dunedin",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Dunedin | TML Agency",
    description: "TML offers expert ai influencer management services in Dunedin, New Zealand. Proven results for businesses across NZ. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-dunedin",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
