...
export const metadata: Metadata = {
  title: "Google Ads Agency in Glasgow | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-glasgow",
  },
  openGraph: {
    title: "Google Ads Agency in Glasgow | TML Agency",
    description: "TML offers expert google ads services in Glasgow. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-glasgow",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
