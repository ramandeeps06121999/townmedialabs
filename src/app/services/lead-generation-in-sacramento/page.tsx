...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Sacramento | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-sacramento",
  },
  openGraph: {
    title: "Lead Generation Agency in Sacramento | TML Agency",
    description: "TML offers expert lead generation services in Sacramento. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-sacramento",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
