...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Memphis | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-memphis",
  },
  openGraph: {
    title: "Graphic Design Agency in Memphis | TML Agency",
    description: "TML offers expert graphic design services in Memphis. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-memphis",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
