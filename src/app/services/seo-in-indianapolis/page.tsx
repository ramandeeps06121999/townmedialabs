...
export const metadata: Metadata = {
  title: "SEO Agency in Indianapolis | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/seo-in-indianapolis",
  },
  openGraph: {
    title: "SEO Agency in Indianapolis | TML Agency",
    description: "TML offers expert seo services in Indianapolis. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/seo-in-indianapolis",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best SEO Agency in Indianapolis | TML Agency" }],
  },
  twitter: {
