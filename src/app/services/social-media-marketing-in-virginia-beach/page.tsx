...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Virginia Beach | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-virginia-beach",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Virginia Beach | TML Agency",
    description: "TML offers expert social media marketing services in Virginia Beach. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-virginia-beach",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
