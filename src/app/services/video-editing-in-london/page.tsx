...
export const metadata: Metadata = {
  title: "Video Editing Agency in London | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/video-editing-in-london",
  },
  openGraph: {
    title: "Video Editing Agency in London | TML Agency",
    description: "TML offers expert video editing services in London. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/video-editing-in-london",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
