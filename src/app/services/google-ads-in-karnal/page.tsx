...
export const metadata: Metadata = {
  title: "Google Ads Agency in Karnal | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-karnal",
  },
  openGraph: {
    title: "Google Ads Agency in Karnal | TML Agency",
    description: "TML offers expert Google Ads management services in Karnal. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-karnal",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Google Ads Agency in Karnal | TML Agency" }],
  },
  twitter: {
