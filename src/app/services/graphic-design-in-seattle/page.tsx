...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Seattle | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-seattle",
  },
  openGraph: {
    title: "Graphic Design Agency in Seattle | TML Agency",
    description: "TML offers expert graphic design services in Seattle. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-seattle",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
