...
export const metadata: Metadata = {
  title: "Google Ads Agency in Amritsar | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-amritsar",
  },
  openGraph: {
    title: "Google Ads Agency in Amritsar | TML Agency",
    description: "TML offers expert Google Ads management services in Amritsar. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-amritsar",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
