...
export const metadata: Metadata = {
  ...
  title: "Music Release Agency in Columbus | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-columbus-oh",
  },
  openGraph: {
    title: "Music Release Agency in Columbus | TML Agency",
    description: "TML offers expert music release services in Columbus. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-columbus-oh",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
