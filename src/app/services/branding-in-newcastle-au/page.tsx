...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/branding-in-newcastle-au",
  },
  openGraph: {
    title: "Branding Agency in Newcastle",
    description: "TML offers expert Branding services in Newcastle. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.com/services/branding-in-newcastle-au",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
...
export default function BrandingInNewcastleAuPage() {
  return (
    <LocationServicePage
      location={location}
