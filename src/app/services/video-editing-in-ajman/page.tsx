...
export const metadata: Metadata = {
  title: "Video Editing Agency in Ajman",
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/video-editing-in-ajman",
  },
  openGraph: {
    title: "Video Editing Agency in Ajman",
    description: "TML offers expert Video Editing services in Ajman. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.com/services/video-editing-in-ajman",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Video Editing Agency in Ajman" }],
  },
  twitter: {
