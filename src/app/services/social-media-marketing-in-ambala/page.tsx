...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Ambala | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-ambala",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Ambala | TML Agency",
    description: "TML offers expert social media marketing services in Ambala. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-ambala",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
