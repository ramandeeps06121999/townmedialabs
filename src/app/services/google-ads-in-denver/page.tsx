...
export const metadata: Metadata = {
  title: "Google Ads Agency in Denver | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-denver",
  },
  openGraph: {
    title: "Google Ads Agency in Denver | TML Agency",
    description: "TML offers expert google ads services in Denver. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-denver",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
