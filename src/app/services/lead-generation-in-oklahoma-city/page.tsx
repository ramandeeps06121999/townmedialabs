...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Oklahoma City | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-oklahoma-city",
  },
  openGraph: {
    title: "Lead Generation Agency in Oklahoma City | TML Agency",
    description: "TML offers expert lead generation services in Oklahoma City. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-oklahoma-city",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
