...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Queenstown",
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/lead-generation-in-queenstown",
  },
  openGraph: {
    title: "Lead Generation Agency in Queenstown",
    description: "TML offers expert Lead Generation services in Queenstown, New Zealand. Proven results for businesses across NZ. Get a free consultation today.",
    url: "https://townmedialabs.com/services/lead-generation-in-queenstown",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Lead Generation Agency in Queenstown" }],
  },
  twitter: {
