...
export const metadata: Metadata = {
  title: "SEO Agency in Luton | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/seo-in-luton-uk",
  },
  openGraph: {
    title: "SEO Agency in Luton | TML Agency",
    description: "TML offers expert seo services in Luton. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/seo-in-luton-uk",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best SEO Agency in Luton | TML Agency" }],
  },
  twitter: {
