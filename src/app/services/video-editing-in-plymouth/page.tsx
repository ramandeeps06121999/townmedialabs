...
export const metadata: Metadata = {
  title: "Video Editing Agency in Plymouth | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/video-editing-in-plymouth",
  },
  openGraph: {
    title: "Video Editing Agency in Plymouth | TML Agency",
    description: "TML offers expert video editing services in Plymouth. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/video-editing-in-plymouth",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
