...
export const metadata: Metadata = {
  title: "Google Ads Agency in Seattle | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-seattle",
  },
  openGraph: {
    title: "Google Ads Agency in Seattle | TML Agency",
    description: "TML offers expert google ads services in Seattle. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-seattle",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
