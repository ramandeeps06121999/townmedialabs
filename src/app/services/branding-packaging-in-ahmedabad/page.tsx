...
export const metadata: Metadata = {
  title: "Branding & Packaging Agency in Ahmedabad | TML Agency",
  ...
  openGraph: {
    ...
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Branding & Packaging Agency in Ahmedabad | TML Agency" }],
  },
  twitter: {
