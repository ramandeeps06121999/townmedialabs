...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Darwin | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-darwin",
  },
  openGraph: {
    title: "Graphic Design Agency in Darwin | TML Agency",
    description: "TML offers expert graphic design services in Darwin. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-darwin",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
