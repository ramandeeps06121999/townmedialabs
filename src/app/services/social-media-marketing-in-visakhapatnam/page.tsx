...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Visakhapatnam | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-visakhapatnam",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Visakhapatnam | TML Agency",
    description: "TML offers expert social media marketing services in Visakhapatnam. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-visakhapatnam",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
