...
export const metadata: Metadata = {
  title: "Music Release Agency in Hyderabad | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-hyderabad",
  },
  openGraph: {
    title: "Music Release Agency in Hyderabad | TML Agency",
    description: "TML offers expert music release and distribution services in Hyderabad. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-hyderabad",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
