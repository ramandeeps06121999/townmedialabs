...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Gold Coast | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-gold-coast",
  },
  openGraph: {
    title: "Lead Generation Agency in Gold Coast | TML Agency",
    description: "TML offers expert lead generation services in Gold Coast. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-gold-coast",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
