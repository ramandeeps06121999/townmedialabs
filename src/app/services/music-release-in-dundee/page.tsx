...
export const metadata: Metadata = {
  title: "Music Release Agency in Dundee | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-dundee",
  },
  openGraph: {
    title: "Music Release Agency in Dundee | TML Agency",
    description: "TML offers expert music release services in Dundee. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-dundee",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Music Release Agency in Dundee | TML Agency" }],
  },
  twitter: {
