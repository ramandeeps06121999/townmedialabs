...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Palmerston North | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-palmerston-north",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Palmerston North | TML Agency",
    description: "TML offers expert social media marketing services in Palmerston North, New Zealand. Proven results for businesses across NZ. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-palmerston-north",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
