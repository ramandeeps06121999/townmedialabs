...
export const metadata: Metadata = {
  title: "Video Editing Agency in Orlando | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/video-editing-in-orlando",
  },
  openGraph: {
    title: "Video Editing Agency in Orlando | TML Agency",
    description: "TML offers expert video editing services in Orlando. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/video-editing-in-orlando",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Video Editing Agency in Orlando | TML Agency" }],
  },
  twitter: {
