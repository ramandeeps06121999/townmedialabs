...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Wolverhampton | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-wolverhampton",
  },
  openGraph: {
    title: "Graphic Design Agency in Wolverhampton | TML Agency",
    description: "TML offers expert graphic design services in Wolverhampton. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-wolverhampton",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
