...
export const metadata: Metadata = {
  title: "Music Release Agency in Lucknow",
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/music-release-in-lucknow",
  },
  openGraph: {
    title: "Music Release Agency in Lucknow",
    description: "TML offers expert Music Release and Distribution services in Lucknow. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.com/services/music-release-in-lucknow",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Music Release Agency in Lucknow" }],
  },
  twitter: {
