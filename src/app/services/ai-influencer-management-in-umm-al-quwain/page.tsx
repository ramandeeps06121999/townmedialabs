...
export const metadata: Metadata = {
  ...
  title: "AI Influencer Management Agency in Umm Al Quwain | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-umm-al-quwain",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Umm Al Quwain | TML Agency",
    description: "TML offers expert ai influencer management services in Umm Al Quwain. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-umm-al-quwain",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
