...
export const metadata: Metadata = {
  title: "Website Development Agency in Ras Al Khaimah | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/website-development-in-ras-al-khaimah",
  },
  openGraph: {
    title: "Website Development Agency in Ras Al Khaimah | TML Agency",
    description: "TML offers expert website development services in Ras Al Khaimah. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/website-development-in-ras-al-khaimah",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
