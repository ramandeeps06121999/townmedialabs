...
export const metadata: Metadata = {
  title: "AI Influencer Management Agency in Dallas | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-dallas",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Dallas | TML Agency",
    description: "TML offers expert ai influencer management services in Dallas. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-dallas",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
