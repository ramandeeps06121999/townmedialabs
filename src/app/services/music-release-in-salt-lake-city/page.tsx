...
export const metadata: Metadata = {
  ...
  title: "Music Release Agency in Salt Lake City | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-salt-lake-city",
  },
  openGraph: {
    title: "Music Release Agency in Salt Lake City | TML Agency",
    description: "TML offers expert music release services in Salt Lake City. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-salt-lake-city",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
