...
export const metadata: Metadata = {
  title: "AI Influencer Management Agency in Oxford | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-oxford",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Oxford | TML Agency",
    description: "TML offers expert ai influencer management services in Oxford. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-oxford",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
