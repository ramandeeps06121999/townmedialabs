...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Vadodara | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-vadodara",
  },
  openGraph: {
    title: "Lead Generation Agency in Vadodara | TML Agency",
    description: "TML offers expert lead generation services in Vadodara. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-vadodara",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
