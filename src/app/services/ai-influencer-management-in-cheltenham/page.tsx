...
export const metadata: Metadata = {
  title: "AI Influencer Management Agency in Cheltenham | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-cheltenham",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Cheltenham | TML Agency",
    description: "TML offers expert ai influencer management services in Cheltenham. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-cheltenham",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
