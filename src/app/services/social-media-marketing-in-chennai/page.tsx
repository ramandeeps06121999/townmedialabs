...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Chennai | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-chennai",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Chennai | TML Agency",
    description: "TML offers expert social media marketing services in Chennai. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-chennai",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
