...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Norwich | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-norwich",
  },
  openGraph: {
    title: "Lead Generation Agency in Norwich | TML Agency",
    description: "TML offers expert lead generation services in Norwich. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-norwich",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
