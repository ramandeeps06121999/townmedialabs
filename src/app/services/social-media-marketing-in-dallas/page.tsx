...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Dallas | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-dallas",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Dallas | TML Agency",
    description: "TML offers expert social media marketing services in Dallas. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-dallas",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
