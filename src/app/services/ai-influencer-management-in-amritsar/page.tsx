...
export const metadata: Metadata = {
  title: "AI Influencer Management Agency in Amritsar | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-amritsar",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Amritsar | TML Agency",
    description: "TML offers expert AI influencer management services in Amritsar. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-amritsar",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
