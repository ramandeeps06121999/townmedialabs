...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Punjab | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-punjab",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Punjab | TML Agency",
    description: "TML offers expert social media marketing services in Punjab. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-punjab",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
