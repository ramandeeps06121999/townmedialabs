...
export const metadata: Metadata = {
  title: "Packaging Design Agency in Derby | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-packaging-in-derby",
  },
  openGraph: {
    title: "Packaging Design Agency in Derby | TML Agency",
    description: "TML offers expert packaging design services in Derby. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-packaging-in-derby",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
