...
export const metadata: Metadata = {
  title: "Branding Agency in Panipat | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-panipat",
  },
  openGraph: {
    title: "Branding Agency in Panipat | TML Agency",
    description: "TML offers expert branding services in Panipat. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-panipat",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
