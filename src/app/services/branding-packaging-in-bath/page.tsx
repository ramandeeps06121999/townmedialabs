...
export const metadata: Metadata = {
  title: "Packaging Design Agency in Bath | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-packaging-in-bath",
  },
  openGraph: {
    title: "Packaging Design Agency in Bath | TML Agency",
    description: "TML offers expert packaging design services in Bath. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-packaging-in-bath",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
