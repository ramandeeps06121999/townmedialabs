...
export const metadata: Metadata = {
  title: "AI Influencer Management Agency in Chennai | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-chennai",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Chennai | TML Agency",
    description: "TML offers expert AI influencer management services in Chennai. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-chennai",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best AI Influencer Management Agency in Chennai | TML Agency" }],
  },
  twitter: {
