...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Kansas City | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-kansas-city",
  },
  openGraph: {
    title: "Graphic Design Agency in Kansas City | TML Agency",
    description: "TML offers expert graphic design services in Kansas City. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-kansas-city",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Graphic Design Agency in Kansas City | TML Agency" }],
  },
  twitter: {
