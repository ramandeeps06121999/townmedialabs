...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Calgary | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-calgary",
  },
  openGraph: {
    title: "Graphic Design Agency in Calgary | TML Agency",
    description: "TML offers expert graphic design services in Calgary, Alberta. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-calgary",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
