...
export const metadata: Metadata = {
  title: "Website Development Agency in Palmerston North | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/website-development-in-palmerston-north",
  },
  openGraph: {
    title: "Website Development Agency in Palmerston North | TML Agency",
    description: "TML offers expert website development services in Palmerston North, New Zealand. Proven results for businesses across NZ. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/website-development-in-palmerston-north",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
