...
export const metadata: Metadata = {
  title: "Graphic Design Agency in San Francisco | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-san-francisco",
  },
  openGraph: {
    title: "Graphic Design Agency in San Francisco | TML Agency",
    description: "TML offers expert graphic design services in San Francisco. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-san-francisco",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
