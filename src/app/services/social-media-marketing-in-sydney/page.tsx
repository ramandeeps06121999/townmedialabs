...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Sydney | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-sydney",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Sydney | TML Agency",
    description: "TML offers expert social media marketing services in Sydney. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-sydney",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
