...
export const metadata: Metadata = {
  title: "Branding Agency in Exeter | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-exeter",
  },
  openGraph: {
    title: "Branding Agency in Exeter | TML Agency",
    description: "TML offers expert branding services in Exeter. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-exeter",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
