...
export const metadata: Metadata = {
  title: "Video Editing Agency in Sydney | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/video-editing-in-sydney",
  },
  openGraph: {
    title: "Video Editing Agency in Sydney | TML Agency",
    description: "TML offers expert video editing services in Sydney. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/video-editing-in-sydney",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
