...
export const metadata: Metadata = {
  title: "Google Ads Agency in Christchurch | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-christchurch",
  },
  openGraph: {
    title: "Google Ads Agency in Christchurch | TML Agency",
    description: "TML offers expert google ads services in Christchurch, New Zealand. Proven results for businesses across NZ. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-christchurch",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Google Ads Agency in Christchurch | TML Agency" }],
  },
  twitter: {
