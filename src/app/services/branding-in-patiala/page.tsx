...
export const metadata: Metadata = {
  title: "Branding Agency in Patiala | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-patiala",
  },
  openGraph: {
    title: "Branding Agency in Patiala | TML Agency",
    description: "TML offers expert branding services in Patiala. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-patiala",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
