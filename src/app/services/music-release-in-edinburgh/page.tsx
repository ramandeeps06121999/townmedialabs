...
export const metadata: Metadata = {
  title: "Music Release Agency in Edinburgh | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-edinburgh",
  },
  openGraph: {
    title: "Music Release Agency in Edinburgh | TML Agency",
    description: "TML offers expert music release services in Edinburgh. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-edinburgh",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
