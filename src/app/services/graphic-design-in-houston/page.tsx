...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Houston | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-houston",
  },
  openGraph: {
    title: "Graphic Design Agency in Houston | TML Agency",
    description: "TML offers expert graphic design services in Houston. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-houston",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
