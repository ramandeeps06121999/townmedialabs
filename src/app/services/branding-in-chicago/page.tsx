...
export const metadata: Metadata = {
  title: "Branding Agency in Chicago | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-chicago",
  },
  openGraph: {
    title: "Branding Agency in Chicago | TML Agency",
    description: "TML offers expert branding services in Chicago. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-chicago",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
