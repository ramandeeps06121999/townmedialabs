...
export const metadata: Metadata = {
  title: "Music Release Agency in Ghaziabad | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-ghaziabad",
  },
  openGraph: {
    title: "Music Release Agency in Ghaziabad | TML Agency",
    description: "TML offers expert music release and distribution services in Ghaziabad. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-ghaziabad",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
