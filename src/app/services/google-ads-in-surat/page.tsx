...
export const metadata: Metadata = {
  title: "Google Ads Agency in Surat | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-surat",
  },
  openGraph: {
    title: "Google Ads Agency in Surat | TML Agency",
    description: "TML offers expert Google Ads management services in Surat. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-surat",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
