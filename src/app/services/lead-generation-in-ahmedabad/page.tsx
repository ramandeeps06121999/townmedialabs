...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Ahmedabad | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-ahmedabad",
  },
  openGraph: {
    title: "Lead Generation Agency in Ahmedabad | TML Agency",
    description: "TML offers expert lead generation services in Ahmedabad. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-ahmedabad",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
