...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Bristol | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-bristol",
  },
  openGraph: {
    title: "Lead Generation Agency in Bristol | TML Agency",
    description: "TML offers expert lead generation services in Bristol. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-bristol",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
