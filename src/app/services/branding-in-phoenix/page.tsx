...
export const metadata: Metadata = {
  title: "Branding Agency in Phoenix | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-phoenix",
  },
  openGraph: {
    title: "Branding Agency in Phoenix | TML Agency",
    description: "TML offers expert branding services in Phoenix. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-phoenix",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
