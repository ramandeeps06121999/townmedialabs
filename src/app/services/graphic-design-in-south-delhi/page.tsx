...
export const metadata: Metadata = {
  title: "Graphic Design Agency in South Delhi | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-south-delhi",
  },
  openGraph: {
    title: "Graphic Design Agency in South Delhi | TML Agency",
    description: "TML offers expert graphic design services in South Delhi. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-south-delhi",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
