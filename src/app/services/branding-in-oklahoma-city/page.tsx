...
export const metadata: Metadata = {
  title: "Branding Agency in Oklahoma City | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-oklahoma-city",
  },
  openGraph: {
    title: "Branding Agency in Oklahoma City | TML Agency",
    description: "TML offers expert branding services in Oklahoma City. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-oklahoma-city",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
