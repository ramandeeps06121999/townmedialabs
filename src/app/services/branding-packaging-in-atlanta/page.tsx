...
export const metadata: Metadata = {
  title: "Packaging Design Agency in Atlanta | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-packaging-in-atlanta",
  },
  openGraph: {
    title: "Packaging Design Agency in Atlanta | TML Agency",
    description: "TML offers expert packaging design services in Atlanta. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-packaging-in-atlanta",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
