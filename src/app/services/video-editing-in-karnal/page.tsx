...
export const metadata: Metadata = {
  title: "Video Editing Agency in Karnal | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/video-editing-in-karnal",
  },
  openGraph: {
    title: "Video Editing Agency in Karnal | TML Agency",
    description: "TML offers expert video editing services in Karnal. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/video-editing-in-karnal",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
