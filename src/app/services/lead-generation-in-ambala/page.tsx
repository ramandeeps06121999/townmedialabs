...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Ambala | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-ambala",
  },
  openGraph: {
    title: "Lead Generation Agency in Ambala | TML Agency",
    description: "TML offers expert lead generation services in Ambala. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-ambala",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
