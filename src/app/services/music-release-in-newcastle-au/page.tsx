...
export const metadata: Metadata = {
  ...
  title: "Music Release Agency in Newcastle | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-newcastle-au",
  },
  openGraph: {
    title: "Music Release Agency in Newcastle | TML Agency",
    description: "TML offers expert music release services in Newcastle. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-newcastle-au",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
