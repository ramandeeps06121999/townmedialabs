...
export const metadata: Metadata = {
  title: "Branding Agency in Milwaukee | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-milwaukee",
  },
  openGraph: {
    title: "Branding Agency in Milwaukee | TML Agency",
    description: "TML offers expert branding services in Milwaukee. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-milwaukee",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
