...
export const metadata: Metadata = {
  ...
  title: "Music Release Agency in New York | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-new-york",
  },
  openGraph: {
    title: "Music Release Agency in New York | TML Agency",
    description: "TML offers expert music release services in New York. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-new-york",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
