...
export const metadata: Metadata = {
  ...
  title: "Video Editing Agency in Palmerston North | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/video-editing-in-palmerston-north",
  },
  openGraph: {
    title: "Video Editing Agency in Palmerston North | TML Agency",
    description: "TML offers expert video editing services in Palmerston North, New Zealand. Proven results for businesses across NZ. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/video-editing-in-palmerston-north",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
