...
export const metadata: Metadata = {
  title: "Video Editing Agency in Denver | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/video-editing-in-denver",
  },
  openGraph: {
    title: "Video Editing Agency in Denver | TML Agency",
    description: "TML offers expert video editing services in Denver. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/video-editing-in-denver",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
