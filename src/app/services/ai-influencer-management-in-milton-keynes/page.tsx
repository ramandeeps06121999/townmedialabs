...
export const metadata: Metadata = {
  ...
  title: "AI Influencer Management Agency in Milton Keynes | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-milton-keynes",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Milton Keynes | TML Agency",
    description: "TML offers expert ai influencer management services in Milton Keynes. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-milton-keynes",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
