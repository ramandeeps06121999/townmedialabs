...
export const metadata: Metadata = {
  title: "Branding & Packaging Agency in Derabassi | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-packaging-in-derabassi",
  },
  openGraph: {
    title: "Branding & Packaging Agency in Derabassi | TML Agency",
    description: "TML offers expert branding and packaging services in Derabassi. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-packaging-in-derabassi",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
