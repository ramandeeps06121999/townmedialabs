...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Jaipur | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-jaipur",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Jaipur | TML Agency",
    description: "TML offers expert social media marketing services in Jaipur. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-jaipur",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
