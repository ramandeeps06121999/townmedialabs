...
export const metadata: Metadata = {
  title: "Video Editing Agency in Aberdeen | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/video-editing-in-aberdeen",
  },
  openGraph: {
    title: "Video Editing Agency in Aberdeen | TML Agency",
    description: "TML offers expert video editing services in Aberdeen. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/video-editing-in-aberdeen",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
