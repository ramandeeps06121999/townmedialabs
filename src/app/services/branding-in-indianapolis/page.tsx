...
export const metadata: Metadata = {
  title: "Branding Agency in Indianapolis",
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/branding-in-indianapolis",
  },
  openGraph: {
    title: "Branding Agency in Indianapolis",
    description: "TML offers expert Branding services in Indianapolis. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.com/services/branding-in-indianapolis",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Branding Agency in Indianapolis" }],
  },
  twitter: {
