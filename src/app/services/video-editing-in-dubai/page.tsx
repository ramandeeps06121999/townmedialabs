...
export const metadata: Metadata = {
  title: "Video Editing Agency in Dubai | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/video-editing-in-dubai",
  },
  openGraph: {
    title: "Video Editing Agency in Dubai | TML Agency",
    description: "TML offers expert video editing services in Dubai. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/video-editing-in-dubai",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
