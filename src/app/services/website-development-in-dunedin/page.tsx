...
export const metadata: Metadata = {
  title: "Website Development Agency in Dunedin | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/website-development-in-dunedin",
  },
  openGraph: {
    title: "Website Development Agency in Dunedin | TML Agency",
    description: "TML offers expert website development services in Dunedin, New Zealand. Proven results for businesses across NZ. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/website-development-in-dunedin",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
