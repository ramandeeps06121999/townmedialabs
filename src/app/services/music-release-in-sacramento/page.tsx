...
export const metadata: Metadata = {
  title: "Music Release Agency in Sacramento | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-sacramento",
  },
  openGraph: {
    title: "Music Release Agency in Sacramento | TML Agency",
    description: "TML offers expert music release services in Sacramento. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-sacramento",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
