...
export const metadata: Metadata = {
  title: "Google Ads Agency in Liverpool | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-liverpool",
  },
  openGraph: {
    title: "Google Ads Agency in Liverpool | TML Agency",
    description: "TML offers expert google ads services in Liverpool. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-liverpool",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
