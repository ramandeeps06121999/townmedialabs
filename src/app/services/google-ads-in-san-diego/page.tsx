...
export const metadata: Metadata = {
  title: "Google Ads Agency in San Diego | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-san-diego",
  },
  openGraph: {
    title: "Google Ads Agency in San Diego | TML Agency",
    description: "TML offers expert google ads services in San Diego. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-san-diego",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
