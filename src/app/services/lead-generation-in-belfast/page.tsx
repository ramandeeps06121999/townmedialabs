...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Belfast | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-belfast",
  },
  openGraph: {
    title: "Lead Generation Agency in Belfast | TML Agency",
    description: "TML offers expert lead generation services in Belfast. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-belfast",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
