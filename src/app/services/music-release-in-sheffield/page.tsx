...
export const metadata: Metadata = {
  title: "Music Release Agency in Sheffield | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-sheffield",
  },
  openGraph: {
    title: "Music Release Agency in Sheffield | TML Agency",
    description: "TML offers expert music release services in Sheffield. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-sheffield",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
