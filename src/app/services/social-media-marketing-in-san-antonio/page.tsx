...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in San Antonio | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-san-antonio",
  },
  openGraph: {
    title: "Social Media Marketing Agency in San Antonio | TML Agency",
    description: "TML offers expert social media marketing services in San Antonio. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-san-antonio",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
