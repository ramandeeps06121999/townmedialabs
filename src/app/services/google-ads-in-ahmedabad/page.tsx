...
export const metadata: Metadata = {
  title: "Google Ads Agency in Ahmedabad | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-ahmedabad",
  },
  openGraph: {
    title: "Google Ads Agency in Ahmedabad | TML Agency",
    description: "TML offers expert Google Ads management services in Ahmedabad. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-ahmedabad",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Google Ads Agency in Ahmedabad | TML Agency" }],
  },
  twitter: {
