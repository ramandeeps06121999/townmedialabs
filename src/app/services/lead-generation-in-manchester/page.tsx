...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Manchester | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-manchester",
  },
  openGraph: {
    title: "Lead Generation Agency in Manchester | TML Agency",
    description: "TML offers expert lead generation services in Manchester. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-manchester",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
