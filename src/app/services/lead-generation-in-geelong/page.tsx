...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Geelong | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-geelong",
  },
  openGraph: {
    title: "Lead Generation Agency in Geelong | TML Agency",
    description: "TML offers expert lead generation services in Geelong. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-geelong",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
