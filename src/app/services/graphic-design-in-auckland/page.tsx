...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Auckland | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-auckland",
  },
  openGraph: {
    title: "Graphic Design Agency in Auckland | TML Agency",
    description: "TML offers expert graphic design services in Auckland. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-auckland",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Graphic Design Agency in Auckland | TML Agency" }],
  },
  twitter: {
