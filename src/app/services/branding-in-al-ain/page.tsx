...
export const metadata: Metadata = {
  title: "Branding Agency in Al Ain | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-al-ain",
  },
  openGraph: {
    title: "Branding Agency in Al Ain | TML Agency",
    description: "TML offers expert branding services in Al Ain. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-al-ain",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
