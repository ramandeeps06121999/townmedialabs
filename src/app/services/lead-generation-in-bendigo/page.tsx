...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Bendigo | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-bendigo",
  },
  openGraph: {
    title: "Lead Generation Agency in Bendigo | TML Agency",
    description: "TML offers expert lead generation services in Bendigo. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-bendigo",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
