...
export const metadata: Metadata = {
  title: "Music Release Agency in Baltimore | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-baltimore",
  },
  openGraph: {
    title: "Music Release Agency in Baltimore | TML Agency",
    description: "TML offers expert music release services in Baltimore. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-baltimore",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
