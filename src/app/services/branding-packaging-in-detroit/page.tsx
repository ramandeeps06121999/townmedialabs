...
export const metadata: Metadata = {
  title: "Packaging Design Agency in Detroit | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-packaging-in-detroit",
  },
  openGraph: {
    title: "Packaging Design Agency in Detroit | TML Agency",
    description: "TML offers expert packaging design services in Detroit. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-packaging-in-detroit",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Packaging Design Agency in Detroit | TML Agency" }],
  },
  twitter: {
