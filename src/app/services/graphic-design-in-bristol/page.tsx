...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Bristol | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-bristol",
  },
  openGraph: {
    title: "Graphic Design Agency in Bristol | TML Agency",
    description: "TML offers expert graphic design services in Bristol. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-bristol",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
