...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Phoenix | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-phoenix",
  },
  openGraph: {
    title: "Graphic Design Agency in Phoenix | TML Agency",
    description: "TML offers expert graphic design services in Phoenix. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-phoenix",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
