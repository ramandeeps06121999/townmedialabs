...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Swansea | TML Agency",
  ...
  openGraph: {
    ...
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Social Media Marketing Agency in Swansea | TML Agency" }],
  },
  twitter: {
