...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Memphis | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-memphis",
  },
  openGraph: {
    title: "Lead Generation Agency in Memphis | TML Agency",
    description: "TML offers expert lead generation services in Memphis. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-memphis",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
