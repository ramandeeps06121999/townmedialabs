...
export const metadata: Metadata = {
  title: "Video Editing Agency in Middlesbrough | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/video-editing-in-middlesbrough",
  },
  openGraph: {
    title: "Video Editing Agency in Middlesbrough | TML Agency",
    description: "TML offers expert video editing services in Middlesbrough. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/video-editing-in-middlesbrough",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Video Editing Agency in Middlesbrough | TML Agency" }],
  },
  twitter: {
