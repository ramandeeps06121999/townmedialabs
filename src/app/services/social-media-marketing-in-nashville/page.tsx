...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Nashville | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-nashville",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Nashville | TML Agency",
    description: "TML offers expert social media marketing services in Nashville. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-nashville",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
