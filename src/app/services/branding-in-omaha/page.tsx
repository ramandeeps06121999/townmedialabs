...
export const metadata: Metadata = {
  title: "Branding Agency in Omaha | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-omaha",
  },
  openGraph: {
    title: "Branding Agency in Omaha | TML Agency",
    description: "TML offers expert branding services in Omaha. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-omaha",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
