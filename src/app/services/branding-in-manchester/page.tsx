...
export const metadata: Metadata = {
  title: "Branding Agency in Manchester | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-manchester",
  },
  openGraph: {
    title: "Branding Agency in Manchester | TML Agency",
    description: "TML offers expert branding services in Manchester. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-manchester",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Branding Agency in Manchester | TML Agency" }],
  },
  twitter: {
