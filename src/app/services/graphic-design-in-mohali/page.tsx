...
export const metadata: Metadata = {
  title: "Graphic Design Agency in Mohali | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/graphic-design-in-mohali",
  },
  openGraph: {
    title: "Graphic Design Agency in Mohali | TML Agency",
    description: "TML offers expert graphic design services in Mohali. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/graphic-design-in-mohali",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
