...
export const metadata: Metadata = {
  title: "AI Influencer Management Agency in Pune | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-pune",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Pune | TML Agency",
    description: "TML offers expert AI influencer management services in Pune. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-pune",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
