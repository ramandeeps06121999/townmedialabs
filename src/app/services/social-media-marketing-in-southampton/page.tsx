...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Southampton | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-southampton",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Southampton | TML Agency",
    description: "TML offers expert social media marketing services in Southampton. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-southampton",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
