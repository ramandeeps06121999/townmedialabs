...
export const metadata: Metadata = {
  ...
  title: "AI Influencer Management Agency in New York | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-new-york",
  },
  openGraph: {
    title: "AI Influencer Management Agency in New York | TML Agency",
    description: "TML offers expert ai influencer management services in New York. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-new-york",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best AI Influencer Management Agency in New York | TML Agency" }],
  },
  twitter: {
