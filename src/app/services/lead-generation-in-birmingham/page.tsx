...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Birmingham | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-birmingham",
  },
  openGraph: {
    title: "Lead Generation Agency in Birmingham | TML Agency",
    description: "TML offers expert lead generation services in Birmingham. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-birmingham",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
