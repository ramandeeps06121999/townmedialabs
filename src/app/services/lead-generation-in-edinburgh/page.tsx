...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Edinburgh | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-edinburgh",
  },
  openGraph: {
    title: "Lead Generation Agency in Edinburgh | TML Agency",
    description: "TML offers expert lead generation services in Edinburgh. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-edinburgh",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
