...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Launceston | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-launceston",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Launceston | TML Agency",
    description: "TML offers expert social media marketing services in Launceston. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-launceston",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Social Media Marketing Agency in Launceston | TML Agency" }],
  },
  twitter: {
