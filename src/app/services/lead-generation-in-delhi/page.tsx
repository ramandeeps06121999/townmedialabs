...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Delhi | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-delhi",
  },
  openGraph: {
    title: "Lead Generation Agency in Delhi | TML Agency",
    description: "TML offers expert lead generation services in Delhi. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-delhi",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
