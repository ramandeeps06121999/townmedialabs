...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Boise | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-boise",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Boise | TML Agency",
    description: "TML offers expert social media marketing services in Boise. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-boise",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
