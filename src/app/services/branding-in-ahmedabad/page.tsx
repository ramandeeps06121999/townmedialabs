...
export const metadata: Metadata = {
  title: "Branding Agency in Ahmedabad | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-ahmedabad",
  },
  openGraph: {
    title: "Branding Agency in Ahmedabad | TML Agency",
    description: "TML offers expert branding services in Ahmedabad. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-ahmedabad",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Branding Agency in Ahmedabad | TML Agency" }],
  },
  twitter: {
