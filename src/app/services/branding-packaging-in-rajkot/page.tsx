...
export const metadata: Metadata = {
  title: "Branding & Packaging Agency in Rajkot | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-packaging-in-rajkot",
  },
  openGraph: {
    title: "Branding & Packaging Agency in Rajkot | TML Agency",
    description: "TML offers expert branding and packaging services in Rajkot. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-packaging-in-rajkot",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Branding & Packaging Agency in Rajkot | TML Agency" }],
  },
  twitter: {
