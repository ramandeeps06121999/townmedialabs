...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in York | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-york",
  },
  openGraph: {
    title: "Social Media Marketing Agency in York | TML Agency",
    description: "TML offers expert social media marketing services in York. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-york",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
