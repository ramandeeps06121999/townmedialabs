...
export const metadata: Metadata = {
  title: "Branding Agency in Rajkot",
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/branding-in-rajkot",
  },
  openGraph: {
    title: "Branding Agency in Rajkot",
    description: "TML offers expert Branding services in Rajkot. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.com/services/branding-in-rajkot",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Branding Agency in Rajkot" }],
  },
  twitter: {
