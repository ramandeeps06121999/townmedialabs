...
export const metadata: Metadata = {
  ...
  title: "AI Influencer Management Agency in Stoke-on-Trent | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-stoke-on-trent",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Stoke-on-Trent | TML Agency",
    description: "TML offers expert ai influencer management services in Stoke-on-Trent. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-stoke-on-trent",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best AI Influencer Management Agency in Stoke-on-Trent | TML Agency" }],
  },
  twitter: {
