...
export const metadata: Metadata = {
  title: "Branding Agency in Coventry | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-coventry",
  },
  openGraph: {
    title: "Branding Agency in Coventry | TML Agency",
    description: "TML offers expert branding services in Coventry. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-coventry",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
