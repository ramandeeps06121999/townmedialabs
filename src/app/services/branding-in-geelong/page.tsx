...
export const metadata: Metadata = {
  title: "Branding Agency in Geelong | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-geelong",
  },
  openGraph: {
    title: "Branding Agency in Geelong | TML Agency",
    description: "TML offers expert branding services in Geelong. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-geelong",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
