...
export const metadata: Metadata = {
  title: "Video Editing Agency in Ahmedabad | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/video-editing-in-ahmedabad",
  },
  openGraph: {
    title: "Video Editing Agency in Ahmedabad | TML Agency",
    description: "TML offers expert video editing services in Ahmedabad. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/video-editing-in-ahmedabad",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
