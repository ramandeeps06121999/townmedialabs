...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/social-media-marketing-in-newcastle-au",
  },
  openGraph: {
    title: "Best Social Media Marketing Agency in Newcastle | TML Agency",
    description: "TML offers expert social media marketing services in Newcastle. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.com/services/social-media-marketing-in-newcastle-au",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
