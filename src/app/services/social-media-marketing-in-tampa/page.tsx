...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Tampa | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-tampa",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Tampa | TML Agency",
    description: "TML offers expert social media marketing services in Tampa. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-tampa",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
