...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Austin | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-austin",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Austin | TML Agency",
    description: "TML offers expert social media marketing services in Austin. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-austin",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
