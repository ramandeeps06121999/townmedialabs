...
export const metadata: Metadata = {
  ...
  title: "Music Release Agency in Gold Coast | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-gold-coast",
  },
  openGraph: {
    title: "Music Release Agency in Gold Coast | TML Agency",
    description: "TML offers expert music release services in Gold Coast. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-gold-coast",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
