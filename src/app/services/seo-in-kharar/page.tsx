...
export const metadata: Metadata = {
  title: "SEO Agency in Kharar | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/seo-in-kharar",
  },
  openGraph: {
    title: "SEO Agency in Kharar | TML Agency",
    description: "TML offers expert search engine optimization services in Kharar. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/seo-in-kharar",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best SEO Agency in Kharar | TML Agency" }],
  },
  twitter: {
