...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Kharar | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-kharar",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Kharar | TML Agency",
    description: "TML offers expert social media marketing services in Kharar. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-kharar",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
