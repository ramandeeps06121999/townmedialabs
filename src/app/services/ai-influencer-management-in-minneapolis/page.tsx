...
export const metadata: Metadata = {
  title: "AI Influencer Management Agency in Minneapolis",
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/ai-influencer-management-in-minneapolis",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Minneapolis",
    description: "TML offers expert AI Influencer Management services in Minneapolis. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.com/services/ai-influencer-management-in-minneapolis",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best AI Influencer Management Agency in Minneapolis" }],
  },
  twitter: {
