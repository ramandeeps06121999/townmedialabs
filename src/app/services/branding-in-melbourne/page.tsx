...
export const metadata: Metadata = {
  title: "Branding Agency in Melbourne | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/branding-in-melbourne",
  },
  openGraph: {
    title: "Branding Agency in Melbourne | TML Agency",
    description: "TML offers expert branding services in Melbourne. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/branding-in-melbourne",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
