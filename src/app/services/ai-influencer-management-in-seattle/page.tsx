...
export const metadata: Metadata = {
  title: "AI Influencer Management Agency in Seattle | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-seattle",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Seattle | TML Agency",
    description: "TML offers expert ai influencer management services in Seattle. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-seattle",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
