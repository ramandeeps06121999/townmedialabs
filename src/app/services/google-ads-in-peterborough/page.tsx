...
export const metadata: Metadata = {
  title: "Google Ads Agency in Peterborough | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-peterborough",
  },
  openGraph: {
    title: "Google Ads Agency in Peterborough | TML Agency",
    description: "TML offers expert google ads services in Peterborough. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-peterborough",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
