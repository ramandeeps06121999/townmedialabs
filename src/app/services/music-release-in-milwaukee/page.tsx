...
export const metadata: Metadata = {
  title: "Music Release Agency in Milwaukee | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-milwaukee",
  },
  openGraph: {
    title: "Music Release Agency in Milwaukee | TML Agency",
    description: "TML offers expert music release services in Milwaukee. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-milwaukee",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
