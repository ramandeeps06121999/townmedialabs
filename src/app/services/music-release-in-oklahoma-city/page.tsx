...
export const metadata: Metadata = {
  ...
  title: "Music Release Agency in Oklahoma City | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-oklahoma-city",
  },
  openGraph: {
    title: "Music Release Agency in Oklahoma City | TML Agency",
    description: "TML offers expert music release services in Oklahoma City. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-oklahoma-city",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
