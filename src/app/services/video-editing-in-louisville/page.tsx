...
export const metadata: Metadata = {
  title: "Video Editing Agency in Louisville | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/video-editing-in-louisville",
  },
  openGraph: {
    title: "Video Editing Agency in Louisville | TML Agency",
    description: "TML offers expert video editing services in Louisville. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/video-editing-in-louisville",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
