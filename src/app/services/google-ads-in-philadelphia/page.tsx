...
export const metadata: Metadata = {
  title: "Google Ads Agency in Philadelphia | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/google-ads-in-philadelphia",
  },
  openGraph: {
    title: "Google Ads Agency in Philadelphia | TML Agency",
    description: "TML offers expert google ads services in Philadelphia. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/google-ads-in-philadelphia",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
