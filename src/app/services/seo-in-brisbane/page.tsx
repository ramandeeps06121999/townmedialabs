...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/seo-in-brisbane",
  },
  openGraph: {
    title: "SEO Agency in Brisbane",
    description: "TML offers expert SEO services in Brisbane. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.com/services/seo-in-brisbane",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best SEO Agency in Brisbane" }],
  },
  twitter: {
