...
export const metadata: Metadata = {
  title: "SEO Agency in Las Vegas | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/seo-in-las-vegas",
  },
  openGraph: {
    title: "SEO Agency in Las Vegas | TML Agency",
    description: "TML offers expert seo services in Las Vegas. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/seo-in-las-vegas",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
