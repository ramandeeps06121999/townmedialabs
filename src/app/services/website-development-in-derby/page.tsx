...
export const metadata: Metadata = {
  title: "Website Development Agency in Derby",
  ...
  alternates: {
    canonical: "https://townmedialabs.com/services/website-development-in-derby",
  },
  openGraph: {
    title: "Website Development Agency in Derby",
    description: "TML offers expert Website Development services in Derby. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.com/services/website-development-in-derby",
    siteName: "TML Agency",
    type: "website",
    locale: "en_IN",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Website Development Agency in Derby" }],
  },
  twitter: {
