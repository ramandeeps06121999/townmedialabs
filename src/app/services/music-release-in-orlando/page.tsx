...
export const metadata: Metadata = {
  title: "Music Release Agency in Orlando | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-orlando",
  },
  openGraph: {
    title: "Music Release Agency in Orlando | TML Agency",
    description: "TML offers expert music release services in Orlando. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-orlando",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Best Music Release Agency in Orlando | TML Agency" }],
  },
  twitter: {
