...
export const metadata: Metadata = {
  title: "Music Release Agency in Boston | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-boston",
  },
  openGraph: {
    title: "Music Release Agency in Boston | TML Agency",
    description: "TML offers expert music release services in Boston. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-boston",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
