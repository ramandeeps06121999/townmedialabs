...
export const metadata: Metadata = {
  title: "Music Release Agency in Townsville | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/music-release-in-townsville",
  },
  openGraph: {
    title: "Music Release Agency in Townsville | TML Agency",
    description: "TML offers expert music release services in Townsville. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/music-release-in-townsville",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
