...
export const metadata: Metadata = {
  title: "Social Media Marketing Agency in Bangalore | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/social-media-marketing-in-bangalore",
  },
  openGraph: {
    title: "Social Media Marketing Agency in Bangalore | TML Agency",
    description: "TML offers expert social media marketing services in Bangalore. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/social-media-marketing-in-bangalore",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
