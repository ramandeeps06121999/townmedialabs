...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Sydney | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/lead-generation-in-sydney",
  },
  openGraph: {
    title: "Lead Generation Agency in Sydney | TML Agency",
    description: "TML offers expert lead generation services in Sydney. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/lead-generation-in-sydney",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
