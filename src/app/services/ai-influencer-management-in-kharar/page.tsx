...
export const metadata: Metadata = {
  title: "AI Influencer Management Agency in Kharar | TML Agency",
  ...
  alternates: {
    canonical: "https://townmedialabs.ca/services/ai-influencer-management-in-kharar",
  },
  openGraph: {
    title: "AI Influencer Management Agency in Kharar | TML Agency",
    description: "TML offers expert AI influencer management services in Kharar. Proven results for 500+ businesses. Get a free consultation today.",
    url: "https://townmedialabs.ca/services/ai-influencer-management-in-kharar",
    siteName: "TML Agency",
    type: "website",
    locale: "en_CA",
