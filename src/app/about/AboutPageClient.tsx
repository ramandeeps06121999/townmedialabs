      ...
      <section className="relative w-full px-6 pt-32 pb-16 md:pt-40 md:pb-24 lg:px-12 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl text-center">
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-white/40 leading-relaxed max-w-3xl mx-auto"
          >
      ...
      <section ref={statsRef} className="relative w-full px-6 py-16 md:py-24 lg:px-12 overflow-hidden">
        <div className="relative mx-auto max-w-7xl">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.1, ease }}
            className="text-sm md:text-base text-white/40 text-center max-w-2xl mx-auto mb-12 md:mb-16"
          >
      ...
      <section className="relative w-full px-6 py-16 md:py-24 lg:px-12 overflow-hidden">
        <div className="relative mx-auto max-w-7xl">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.1, ease }}
            className="text-sm md:text-base text-white/40 max-w-2xl mb-12 md:mb-16"
          >
