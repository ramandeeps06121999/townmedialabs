...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Absolutely! While our office is based in Chandigarh, we work with clients across India and internationally. We use video calls, project management tools, and regular updates to ensure seamless collaboration regardless of location.",
  },
];
...
export default function ContactPageClient() {
  ...
  const inputClasses = (field: string) =>
    `w-full bg-white/[0.04] border rounded-xl px-5 py-4 text-sm text-white placeholder:text-white/30 focus:outline-none transition-all duration-300 ${
      focusedField === field
        ...
        <div className="relative mx-auto max-w-5xl">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {contactCards.map((card, i) => (
              ...
              >
                <div className="flex justify-center mb-4 text-white/30 group-hover:text-[#ff4500] transition-colors duration-300">
                  {card.icon}
                </div>
